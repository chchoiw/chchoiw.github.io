...
| 情況|劃分原則|
|----|----|
|輸入條件規定了輸入數據取值范圍|1個有效等價類、2個無效等價類|
|輸入條件規定了輸入數據的「數效|1個有效等價類、2個無效等價類|
|輸入條件規定了輸入數據的一組可能取值|每一個輸入值確定1個有效等價類， 針對這組值確定1個無效等價類|
...
id4[把因果圖*轉換*成*判定表*]
id5[把判定表的*每一列*拿出來作為依據,*設計測試用例*1]
