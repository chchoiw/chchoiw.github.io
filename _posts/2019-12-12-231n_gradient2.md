...
\langle Z_{*j}, \mathbf 1_N \rangle=\sum_{t} Z_{t,j} \quad \text{for } j=1,2,\dots, C  \label{3}
$$
...
\left(\frac{\partial l}{\partial Y}\frac{\partial Y}{\partial W}\right)_{*,*,hh,ww}&=\sum_{i,j}(\bar Z^{i,j})^T (\bar X^{i,j})\label{7}\\ 
\end{align}
$$
...
\left(\frac{\partial l}{\partial Y}\frac{\partial Y}{\partial X}\right)_{*,*,iHH+hh,jWW+ww}&=(\bar Z^{i,j}) (\bar W^{hh,ww}) \label{8}\\ 
\end{aligned}
$$
...
\begin{align}
\left(\frac{\partial l}{\partial Y}\frac{\partial Y}{\partial X}\right)_{n,c,iHH+hh,jWW+ww}
&=Z_{n,c,i,j}\frac{\partial Y_{n,c,i,j}}{\partial X_{n,c,iHH+hh,jWW+ww}} \label{10}\\
&=Z_{n,c,i,j}
\end{align}
$$
...
\begin{align}
\left(\frac{\partial l}{\partial Y}\frac{\partial Y}{\partial X}\right)_{n,c,iHH+hh,jWW+ww}
&=Z_{n,c,i,j}\frac{\partial Y_{n,c,i,j}}{\partial X_{n,c,iHH+hh,jWW+ww}}  \label{11}\\
&=0
\end{align}
$$
