...
- [The jocobian matrix with respect to $W$](#the-jocobian-matrix-with-respect-to-mathsemanticsmrowmiwmimrowannotation-encoding%22applicationx-tex%22wannotationsemanticsmathw)
- [The jocobian matrix with respect to $X$](#the-jocobian-matrix-with-respect-to-mathsemanticsmrowmixmimrowannotation-encoding%22applicationx-tex%22xannotationsemanticsmathx)
- [The jocobian matrices with respect to $b$](#the-jocobian-matrices-with-respect-to-mathsemanticsmrowmibmimrowannotation-encoding%22applicationx-tex%22bannotationsemanticsmathb)
- [Gradient of the convolution layer](#gradient-of-the-convolution-layer)
- [The gradient with respect to $W$](#the-gradient-with-respect-to-mathsemanticsmrowmiwmimrowannotation-encoding%22applicationx-tex%22wannotationsemanticsmathw)
- [The gradient with respect to $X$](#the-gradient-with-respect-to-mathsemanticsmrowmixmimrowannotation-encoding%22applicationx-tex%22xannotationsemanticsmathx)
- [The gradient with respect to $b$](#the-gradient-with-respect-to-mathsemanticsmrowmibmimrowannotation-encoding%22applicationx-tex%22bannotationsemanticsmathb)
