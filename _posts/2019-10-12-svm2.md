...
K: X\times X \rightarrow \R$ s.t. for all $x,z\in X$
...
Let $x=\left[ \begin{matrix} x_1\\z_2\end{matrix} \right],z=\left[ \begin{matrix} z_1\\z_2\end{matrix} \right] \in \R^2$ and the nonlinear map
$$ \phi:\R^2\rightarrow \R^3 \text{defined by } \phi(x) =\left[ \begin{matrix} x_1^2\\x_2^2 \\ \sqrt 2 x_1x_2 \end{matrix} \right] ,$$
...
## Example of Kernel
$$
K(A,B):\R^{l\times n}\times \R^{n\times \bar l}
$$
For $A\in \R^{l\times n}, a\in \R^l ,\mu \in \R$
- Polynomial kernel
