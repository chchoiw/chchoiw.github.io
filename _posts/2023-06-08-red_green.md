...
- 亦因為介紹了有隱藏和顯示細項的功能, 所以點擊大項名稱的燈便會展開和隱藏
 <div style="text-align:center;" id="image1"><img src="/images/red_green/red_green_one.gif" /></div>
...
- 並且使用```setIntervel```去更新頁面, 檢測到有儀器有紅燈的狀態也會更新頁面呈現
 ...
 <div style="text-align:center;" id="image1"><img src="/images/red_green/red_green_select.gif" /></div>
