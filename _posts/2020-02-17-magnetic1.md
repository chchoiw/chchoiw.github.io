...
<div style="text-align:center"><img src="/images/high_school_physics/magnetic3.PNG" /></div>

$$
\begin{align}
\Delta\vec{ B} 
&=\frac{\mu_0}{4 \pi} \frac{i \Delta\vec{ l} \times {r^3} \label{Biot-Savart Law vector} 
\\
\vert \Delta\vec{ B} \vert 
&=\frac{\mu_0}{4 \pi} \frac{i \Delta\vec{ l} \sin \theta}{r^2} \label{Biot-Savart Law}
\end{align}
$$
