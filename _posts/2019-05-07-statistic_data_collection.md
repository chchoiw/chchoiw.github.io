...
- 統計調查
  - 是根據統計設計規定的統計調查對象、統計指標、分類標準和調查方法，有組織地向調查對象蒐集原始數據的過程它的任務是取得原始數據，然後對這些原始數據進行數護整理和統計加工，形成規範的統計資料。
  - 要求：準確性、及時性、系統性和全面性。
- 統計分析
  - 是運用統計方法，通過對統計數據和有關情況的系統整和研究，從數量方面來說明經濟社會現象的變化，揭示其本質和光律性，預測未來發展趨勢
- 政府常用的調查方法
...
| 比較項目      |  優點     |    缺點   |
| --- | --- | --- |
|  面對面訪問     | 1. 較高回應率<br>2. 經由雙向、當面確認答案，減少誤解題意<br>3. 應付臨時狀況,靈活度高<br>4. 提供大較大量且深入的資<br>5.提供較為可靠的資料<br>6. 減少漏答的可能性     | (1)成本較高<br>(2)時間較長<br>(3)品質監控較為困難<br>(4)受訪者的被壓迫感較大<br>(5)訪員臨場表現影響受訪者的反應<br>(6)訪員的素質要求較高<br>(7)動員大量訪員      |
|  電話訪問     | (1)訪問與資料處理具有時效性<br>(2)集中作業，可利用督導監督訪問品質<br>(3)可確保受訪者做出適當的回應<br>(4)可蒐集大量樣本      | (1)拒訪的比例較高<br>(2)訪問時間不能太長<br>(3)調查題目不能太複雜<br>(4)抽樣清冊的涵蓋率影響樣本代表性      |
